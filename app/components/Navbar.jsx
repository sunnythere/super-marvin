...
export default connect(mapState, mapDispatch)(class Navbar extends Component {
...
render() {
  ...
  return (
    ...
    <div id="navbar" style={scrollStyle}>
            ...
            <div className="menu">
              {
               ...
               : <div>
                  <Link to="/visitor">Visitor Log</Link>
                  <br/>
                  <Link to="/history">Visitor History</Link>
                  <br/>
